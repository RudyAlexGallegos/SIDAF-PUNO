...
interface ArbitroData {
  ...
  nivelPreparacion: string  // Básico, Intermedio, Avanzado
...
export default function NuevoArbitroPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Mapear campos del frontend al formato del backend (nueva estructura)
      const arbitroData = {
        // === Sección 1: Identificación ===
        // El backend espera: nombre (string), apellido (string)
        // Combinamos los nombres y apellidos del formulario
        nombre: form.nombres,
