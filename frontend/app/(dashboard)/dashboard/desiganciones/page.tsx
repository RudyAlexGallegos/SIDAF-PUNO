...
export default function DesignacionesPage() {
  ...
  // Redirigir automáticamente a la ruta correcta si alguien visita la carpeta mal escrita
  useEffect(() => {
    router.replace('/dashboard/designaciones')
  }, [])
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6 sm:mb-8">
          ...
          >
            <Link href="/dashboard/designaciones/nueva" className="flex items-center justify-center space-x-2">
